...
namespace FiendMagicDestiny_bot
{
    internal class StateMachine
    {
        ...
        private protected static Dictionary<long, string> _Tarostring;
        ...
        public StateMachine()
        {
            ...
            _Tarostring = new Dictionary<long, string>();
        }
        ...
        public void SaveTarots(long chatId, string tarostring)
        {
            if (_Tarostring.ContainsKey(chatId))
                _Tarostring[chatId] = tarostring;
            else
                _Contact.Add(chatId, tarostring);
        }
        public void 
