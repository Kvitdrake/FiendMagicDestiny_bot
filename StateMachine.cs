    ...
    internal class StateMachine : FileDestiny
    {
        ...
        public void BuilderList(long chatId)
        {
            ...
            AddArcan(6, "   ВЛЮБЛЁННЫЕ", $"{Desc.Lovers} ",
                                         $"{Desc.Lovers} ");
            AddArcan(7, "   КОЛЕСНИЦА", $"*описание от тебя аркана для мужчины",
                                        $"*описание от тебя аркана для женщины");
            AddArcan(8, "   ПРАВОСУДИЕ", $"*описание от тебя аркана для мужчины", 
                                         $"*описание от тебя аркана для женщины");
            AddArcan(9, "   ОТШЕЛЬНИК", $"*описание от тебя аркана для мужчины",
                                        $"*описание от тебя аркана для женщины");
            AddArcan(10, "   КОЛЕСО ФОРТУНЫ", $"*описание от тебя аркана для мужчины",
                                              $"*описание от тебя аркана для женщины");
            AddArcan(11, "   СИЛА", $"*описание от тебя аркана для мужчины", 
                                    $"*описание от тебя аркана для женщины");
            AddArcan(12, "   ПОВЕШЕННЫЙ", $"*описание от тебя аркана для мужчины",
                                          $"*описание от тебя аркана для женщины");
            AddArcan(13, "   СМЕРТЬ", $"*описание от тебя аркана для мужчины",
                                      $"*описание от тебя аркана для женщины");
            AddArcan(14, "   УМЕРЕННОСТЬ", $"*описание от тебя аркана для мужчины",
                                           $"*описание от тебя аркана для женщины");
            AddArcan(15, "   Дьявол", $"*описание от тебя аркана для мужчины",
                                      $"*описание от тебя аркана для женщины");
            AddArcan(16, "   БАШНЯ", $"*описание от тебя аркана для мужчины",
                                     $"*описание от тебя аркана для женщины");
            ...
            AddCombination(1, 13, 12, $"Есть у человека аркан Мага, идет вместе с арканом Смерти, или с арканом Повешенный, то он будет копать настолько глубоко, что ему будут говорить «ты словно прокурор, как ты прознал про все»! Маги со Смертью могут тебе всю Библию за 5 минут рассказать. Всю информацию сожмут, всю воду уберут, и самую суть выдадут в готовом варианте. {indent}");
            ...
            AddCombination(6, 9, $"Влюбленны е и Отшельник – несколько браков, выбор партнеров с сильным интеллектом, умение скрывать свою личную жизнь.");
